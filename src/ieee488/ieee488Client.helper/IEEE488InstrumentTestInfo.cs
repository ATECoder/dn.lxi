...
public static class IEEE488InstrumentTestInfo
{
    ...
    public static string ResetClearDevice( InstrumentId instrumentId, TimeSpan connectionTimeout )
    {
        ...
        using var vxi11Client = new isr.LXI.IEEE488.Ieee488Client();
    ...
    private static string QueryDevice( isr.LXI.IEEE488.Ieee488Client vxi11Client, string command, bool trimEnd )
    {
        try
        {
    ...
    /// <param name="command">      The command. </param>
    /// <returns>   A string. </returns>
    private static string WriteDevice( isr.LXI.IEEE488.Ieee488Client vxi11Client, string command )
    {
        try
        {
