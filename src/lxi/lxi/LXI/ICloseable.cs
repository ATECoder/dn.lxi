...
internal interface ICloseable : IDisposable
{
    ...
    /// </item></list>
    /// <list type="bullet"> <item>
    /// The <see cref="IDisposable.Dispose()"/> method skips if <see cref="IsDisposed"/> is <see langword="true"/>
    /// ; </item><item>
    /// The <see cref="XDR.XdrEncodingStreamBase.Dispose(bool)"/> accumulates and throws an aggregate
    /// exception </item><item>
    /// The <see cref="IDisposable.Dispose()"/> method throws the aggregate exception from <see cref="XDR.XdrEncodingStreamBase.Dispose(bool)"/>
    /// . </item></list>
    /// </remarks>
    void Close();
