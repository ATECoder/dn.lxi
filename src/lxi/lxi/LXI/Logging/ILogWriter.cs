...
public static class LogWriterExtensions
{
    ...
    /// <remarks>   2023-03-23. </remarks>
    /// <param name="logWriterlogWriter">   The <see cref="ILogWriter"/> to act on. </param>
    /// <param name="message">              The message. </param>
    /// <param name="ex">                   The exception. </param>
    public static void LogError( this ILogWriter logWriterlogWriter, string message, Exception ex )
    {
        if ( logWriterlogWriter.IsEnabled( LogWriterLevel.Error ) )
            logWriterlogWriter.Write( LogWriterLevel.Error, BuildMessage( message, ex ) );
    }
